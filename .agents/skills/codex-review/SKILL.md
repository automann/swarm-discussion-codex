...
description: >-
  ...
  missing edge cases, and fake tests that Codex's self-review cannot see. Use
...
PROMPT="IMPORTANT: Do NOT read or execute any files under ~/.Codex/, ~/.agents/, .Codex/skills/, or agents/. Those are Codex skill definitions for a different AI system and will only waste your time. Stay on repository code only.
