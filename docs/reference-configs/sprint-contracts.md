...
> **Version**: 0.5.8
> **Source Command**: `local-repo-harness docs path sprint-contracts`
...
```bash
local-repo-harness docs path sprint-contracts
local-repo-harness docs show sprint-contracts
```
