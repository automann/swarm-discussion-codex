...
> **Version**: 0.5.8
> **Source Command**: `local-repo-harness docs path heartbeat-triage`
...
```bash
local-repo-harness docs path heartbeat-triage
local-repo-harness docs show heartbeat-triage
```
