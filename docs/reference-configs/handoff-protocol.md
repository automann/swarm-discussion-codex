...
> **Version**: 0.5.8
> **Source Command**: `local-repo-harness docs path handoff-protocol`
...
```bash
local-repo-harness docs path handoff-protocol
local-repo-harness docs show handoff-protocol
```
